...
@app.route('/soon')
def event_soon():
    # Add any necessary data processing or logic here
...
@app.route('/eventdel')
def eventdel():
    return render_template('eventdel.html')

@app.route('/eventhar')
def eventhar():
    return render_template('eventhar.html')

@app.route('/eventbih')
def eventbih():
    return render_template('eventbih.html')
...
@app.route('/eventss')
def eventss():
    return render_template('eventss.html')
